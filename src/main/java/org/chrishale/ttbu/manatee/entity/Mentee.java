...
@Entity
@XmlRootElement
public class Mentee extends Person implements Serializable {

    private static final long serialVersionUID = 1L;

    @Column(name = "menteeid", unique = true)
    @NotNull
    ...
    public int hashCode() {
        int hash = 0;
        hash += (menteeid != null ? menteeid.hashCode() : 0);
        return hash;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Mentee)) {
            return false;
        }
        Mentee other = (Mentee) object;
        if ((this.menteeid == null && other.menteeid != null) || (this.menteeid != null && !this.menteeid.equals(other.menteeid))) {
            return false;
        }
        return true;
    }
    ...
    public String toString() {
        return "org.chrishale.ttbu.manatee.entity.Mentee[ id=" + menteeid + " ]";
    }
